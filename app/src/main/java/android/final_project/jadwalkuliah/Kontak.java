    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fb1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("fb://profile/100023931247779"));
                    startActivity(intent);
                } catch(Exception e) {
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.facebook.com/pearl.maknun")));
                }
            }
        });
        ...
        gm1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts(
                        "mailto","almaknunlulu@gmail.com", null));
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    startActivity(new Intent(Intent.ACTION_VIEW,
                            Uri.parse("http://instagram.com/pearl_maknun")));
                }
            }
        });
